...
export const data = [
    ...
    }, // data 배열 의 두번째 원소 : 객체2 (생선 타코)
    {
        "name": "매운 오징어 떡볶이",
        "ingredients": [
          { "name": "오징어", "amount": 500, "measurement": "그램" },
          { "name": "치즈", "amount": 1, "measurement": "컵" },
          { "name": "양배추", "amount": 2, "measurement": "컵" },
          { "name": "백종원 매운양념", "amount": 2, "measurement": "컵" },
          { "name": "대파", "amount": 2, "measurement": "개(큰것)"},
          { "name": "마늘", "amount": 3, "measurement": "개" }
        ],
        "steps": [
          "모든재료을 냄비에 익힌다.",
          "치즈 3장을 얹는다.",
